...
var KTCreateApp = function () {
    ...
    return {
        init: function () {
            (t = document.querySelector("#kt_modal_create_app")) && (e = new bootstrap.Modal(t), (r = document.querySelector("#kt_modal_create_app_stepper")) && (o = document.querySelector("#kt_modal_create_app_form"), i = document.querySelector('[data-kt-stepper-action="submit"]'), (a = new KTStepper(r)).on("kt.stepper.next", (function (e) {
                console.log("stepper.next");
                var t = n[e.getCurrentStepIndex() - 1];
                t ? t.validate().then((function (t) {
                    console.log("validated!"), "Valid" == t ? (e.goNext(), KTUtil.scrollTop()) : Swal.fire({
                        text: "Harap mengisi kolom yang kosong!!",
                        icon: "error",
                        buttonsStyling: !1,
                ...
                fields: {
                    name: {
                        validators: {
                            notEmpty: {
                                message: "Nama Produk masih kosong!"
                            }
                        }
                    },
                },
