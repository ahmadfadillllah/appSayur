...
<body id="kt_body" class="bg-body">
    ...
    <div class="d-flex flex-column flex-root">
        ...
        <div class="d-flex flex-column flex-column-fluid bgi-position-y-bottom position-x-center bgi-no-repeat bgi-size-contain bgi-attachment-fixed"
            style="background-image: url({{ asset('admin/dist/assets') }}/media/illustrations/development-hd.png)">
            <!--begin::Content-->
            <div class="d-flex flex-center flex-column flex-column-fluid p-10 pb-lg-20">
                <!--begin::Logo-->
                {{-- <a href="../../demo1/dist/index.html" class="mb-12">
						<img alt="Logo" src="{{ asset('admin/dist/assets/media/logos/logo-2-dark.svg') }}" class="h-45px" />
					</a> --}}
                <!--end::Logo-->
                <!--begin::Wrapper-->
                <div class="w-lg-600px bg-body rounded shadow-sm p-10 p-lg-15 mx-auto">
                    <!--begin::Form-->
                    <form class="form w-100" method="POST" action="{{ route('processregister') }}">
                        {{ csrf_field() }}
                        <!--begin::Heading-->
                        ...
                        <div class="fv-row mb-7">
                            ...
                            @enderror
                            <input class="form-control form-control-lg form-control-solid" type="tezt" placeholder=""
                        ...
                        <div class="fv-row mb-7">
                            ...
                            <input class="form-control form-control-lg form-control-solid" type="tezt"
                                placeholder="jl. tinumbe lR.142" name="alamat" autocomplete="off" />
                        </div>
                        <!--end::Input group-->
                        <!--begin::Input group-->
                        <div class="fv-row mb-7">
                            ...
                            @enderror
                            <input class="form-control form-control-lg form-control-solid" type="tezt"
                                placeholder="makassar" name="kota" autocomplete="off" />
                        </div>
                        <!--end::Input group-->
                        <!--begin::Input group-->
                        <div class="fv-row mb-7">
                            ...
                            @enderror
                            <input class="form-control form-control-lg form-control-solid" type="tezt"
                                placeholder="88917" name="postal_code" autocomplete="off" />
                        </div>
                        <!--end::Input group-->
                        <!--begin::Input group-->
                        <div class="fv-row mb-7">
